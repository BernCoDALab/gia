...
schedule$reading <- paste0("[", schedule$reading, "](lectures/", sprintf("%02d", schedule$session_nr), "/", schedule$reading, ".html)")
...
gt::gt(data=schedule_for_display) %>% gt::fmt_markdown(columns = c(slides, slides_pdf))
```
